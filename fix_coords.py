...
def main():
    ...
    for i, seg in enumerate(segments):
        ...
        # Ravenna Nord -> Imola (coordinate complete da OSM Overpass)
        if "Ravenna Nord" in start_name and "Imola" in end_name:
            seg["route_coords"] = [
                # Way A14 (Ravenna Nord area)
                [44.3459525, 11.8398457], [44.3461285, 11.8394358],
                [44.3470727, 11.8373332], [44.3475912, 11.8359570],
                [44.3481112, 11.8344284], [44.3487250, 11.8324801],
                [44.3497807, 11.8290468], [44.3507220, 11.8260939],
                [44.3517548, 11.8228007], [44.3521759, 11.8214580],
                [44.3556216, 11.8104700],
                # Way no-ref (gap area)
                [44.3584037, 11.8015462], [44.3589309, 11.7998110],
                [44.3591337, 11.7991434], [44.3605697, 11.7945772],
                [44.3607362, 11.7940598], [44.3615889, 11.7914101],
                [44.3619356, 11.7905368], [44.3621284, 11.7900512],
                [44.3638427, 11.7861793], [44.3642019, 11.7854049],
                # Continuation through gap
                [44.3653763, 11.7828727], [44.3675008, 11.7782348],
                [44.3690988, 11.7746388], [44.3705713, 11.7706820],
                [44.3731236, 11.7635666], [44.3759396, 11.7556444],
                [44.3778352, 11.7503058], [44.3783383, 11.7488552],
